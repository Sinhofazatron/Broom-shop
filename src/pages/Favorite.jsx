...
function Favorite() {
  ...
  return (
    <div className="favorite">
      <div>
        <div className="favorite__top">
          ...
          <button onClick={onClickClear} className="cart__clear">
            ...
            <span className="cart__clear__text">Очистить все</span>
          </button>
        </div>
      ...
      <Link to="/" className="favorite__bottom-buttons-back-btn-link">
        <button className="cart-btn favorite__bottom-buttons-back-btn">
          <svg
